...
/**
 * @minions-orders/cli — CLI for Minions Orders
 *
...
import { customTypes } from '@minions-orders/sdk';
...
program
    ...
    .action(() => {
        console.log(chalk.bold('Minions Orders'));
        console.log(chalk.dim('Order records, service selections, onboarding checklists, and invoices'));
        console.log('');
        console.log(`  SDK:    ${chalk.cyan('@minions-orders/sdk')}`);
        console.log(`  CLI:    ${chalk.cyan('@minions-orders/cli')}`);
        console.log(`  Python: ${chalk.cyan('minions-orders')}`);
